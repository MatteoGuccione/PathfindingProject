...
namespace EsameFineAnnoVS
{
    class HousePlayScene : Scene
    {
        ...
        public void CreateBedDialogues()
        {
            dialogueBox.isActive = true;
            Vector2 wordPosition = new Vector2(0, 510);
            dialogue1 = new TextObject(wordPosition, "I am feeling extremely tired", FontMngr.GetFont(), 0);
            Vector2 wordPosition2 = new Vector2(0, 550);
            dialogue2 = new TextObject(wordPosition2, "maybe i should go to bed", FontMngr.GetFont(), 0);
